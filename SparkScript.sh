...
command spark-submit --queue default  --class pradhan.com.spark.SparkSQLSample SparkSQLSample-0.0.1-SNAPSHOT-jar-with-dependencies.jar 2>>spark-maven-log.txt;
